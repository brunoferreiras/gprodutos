...
-- -----------------------------------------------------
-- Table `gprodutos`.`transacoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gprodutos`.`transacoes` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `users_id` BIGINT(20) NOT NULL,
  `produtos_id` BIGINT(20) NOT NULL,
  `quantidade_saida` INT(20) NULL,
  `horas_saida` DATETIME NULL,
  `quantidade_entrada` INT(20) NULL,
  `horas_entrada` DATETIME NULL,
